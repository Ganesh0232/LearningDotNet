...
{
    public class KithabController : Controller
    {
        private readonly MVCLibraryContext _context;

        public KithabController(MVCLibraryContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Book != null ? 
                          ...
                          Problem("Entity set 'MVCLibraryContext.Book'  is null.");
        }

        // GET: Kithab/Details/5
